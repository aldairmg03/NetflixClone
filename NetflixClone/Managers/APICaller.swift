...
struct Constants {
    ...
    static let YOUTUBE_API_KEY = "AIzaSyDax455MDIbQBDjkavYigBWJGfBWaCFoeM"
...
class APICaller {
    ...
    // GET https://youtube.googleapis.com/youtube/v3/search?q=Avengers&key=[YOUR_API_KEY] HTTP/1.1
